...
public class ServerMoney implements ModInitializer {
    ...
    public static final BlockEntityType<PayButtonBlockEntity> PAY_BUTTON_BET = FabricBlockEntityTypeBuilder.create(PayButtonBlockEntity::new, PAY_BUTTON_BLOCK).build();
    @Override
